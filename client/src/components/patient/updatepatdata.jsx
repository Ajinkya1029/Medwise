...
setMobile(props.list.mobile)
    ...
    function submit(e){
        ...
        console.log(name)
        if(name===props.list.name&&email===props.list.email&&mobile===props.list.mobile&&address===props.list.address){
alert("No Changes Made");
        }else{

            fetch("http://localhost:1000/patient/update",{
                method:"PUT",
                headers:{
                ...
                body:JSON.stringify({name,email,address,mobile})
